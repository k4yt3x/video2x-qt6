...
<TS version="2.1" language="ja_JP">
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;使用するエンコードのプリセットです。処理が遅いプリセットでは圧縮効率 (品質とファイルサイズの比率) が向上し、処理が速いプリセットでは圧縮効率が低下しますがエンコードが速くなります。&lt;/p&gt;&lt;p&gt;- ultrafast&lt;br/&gt;- superfast&lt;br/&gt;- veryfast&lt;br/&gt;- faster&lt;br/&gt;- fast&lt;br/&gt;- medium&lt;br/&gt;- slow – 既定のプリセット&lt;br/&gt;- slower&lt;br/&gt;- veryslow&lt;br/&gt;- placebo&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
